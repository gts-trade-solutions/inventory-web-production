  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Demo mode accent — the banner and badges use this so a screenshot is never ambiguous
        // about which database it came from (DEMO_MODE.md §7).
        demo: {
          DEFAULT: 'hsl(var(--demo))',
          foreground: 'hsl(var(--demo-foreground))',
        },
        // Stock and expiry status colours, used by badges across inventory screens.
